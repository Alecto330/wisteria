...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/style_offertaAmm.css">
        ...
        <div class="card">
            <div class="scroll-wrapper-classifica">
                <div class="job-header" style="margin-top: 5px">
                    ...
                    <button class="btn btn-primary" style="margin-left: auto; " onclick="cancellaPosizione">Cancella</button>
        ...
        <div class="card">
            <div class="scroll-wrapper-classifica">
                ...
                <div class="ranking-list">
                    <!-- RENDERE RESPONSIVE-->
                    <div class="ranking-item" href="${pageContext.request.contextPath}/visualizzacandidato" style="cursor: pointer">
