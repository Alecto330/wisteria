    ...
    <div class="footer-content">
        <div class="footer-branding">
            ...
            <div class="footer-social">
                <a href="https://www.facebook.com/Wisteria" target="_blank" class="social-link" aria-label="Facebook">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a href="https://www.x.com/Wisteria" target="_blank" class="social-link" aria-label="X">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                        <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                    </svg>
                </a>
                <a href="https://www.linkedin.com/company/Wisteria" target="_blank" class="social-link" aria-label="LinkedIn">
        ...
        <div class="footer-links">
            <div class="footer-column">
                ...
                <ul class="footer-list">
                    ...
                    <li><a href="https://wisteria.blogspot.com" target="_blank">Blog</a></li>
                </ul>
            </div>
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-content">
            ...
            <div class="footer-bottom-links">
                <a href="${pageContext.request.contextPath}/templates/privacypolicy.jsp" target="_blank">Privacy Policy</a>
                <span class="separator">|</span>
                <a href="${pageContext.request.contextPath}/templates/terminicondizioni.jsp" target="_blank">Termini e Condizioni</a>
            </div>
        </div>
    </div>
</footer>